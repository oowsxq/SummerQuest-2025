            ...
            for record in all_records:
                ...
                if isinstance(field_val, str) and field_value in field_val:
                    ...
                    for item in field_val:
                        if isinstance(item, dict) and field_value in item.get('en_name', ''):
                            filtered_records.append(record)
...
if __name__ == "__main__":
    # 从环境变量获取配置信息
    app_id = os.environ.get("FEISHU_APP_ID", "cli_a8e1d40f892e100d")
    app_secret = os.environ.get("FEISHU_APP_SECRET", "ntWlUz0BYO437ZA0WZjBlfsgICwXU6Xc")
    bitable_url = "https://fudan-nlp.feishu.cn/base/KH8obWHvqam2Y4sXGGuct2HFnEb?table=tbljlS1fS0UepxBn&view=vewCig26Kk"
    
    # 检查是否提供了真实凭据
    if app_id != "cli_a8e1d40f892e100d" or app_secret != "ntWlUz0BYO437ZA0WZjBlfsgICwXU6Xc":
    ...
    # 2. 筛选特定字段的记录
    # print("主讲 或 助教 中包含 “刘智耿” 的条目:")
    field_names = ["主讲", "助教"]  # 替换为你的字段名
