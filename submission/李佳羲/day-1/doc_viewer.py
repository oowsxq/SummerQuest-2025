...
class SimpleLark:
    ...
    def get_filtered_records(self, table_name: str = "default", field_name: str = "", field_value: str = "") -> List[Dict[str, Any]]:
        ...
        field_name支持用“或”分隔多个字段，实现“或”逻辑
        """
        ...
        if field_name and field_value:
            ...
            fields_list = field_name.split('或')
            ...
            for record in all_records:
                ...
                for current_field in fields_list:
                    person_list = fields.get(current_field,[])
                    # 遍历每个人
                    for person in person_list:
                        if isinstance(person,dict) and person.get("en_name")==field_value:
...
if __name__ == "__main__":
    # 从环境变量获取配置信息
    app_id = os.environ.get("FEISHU_APP_ID", "cli_a8e0e8affdf9d00e")
    app_secret = os.environ.get("FEISHU_APP_SECRET", "UEykZQfDXYEROvbtCLKUmuzpIy6RVvdt")
