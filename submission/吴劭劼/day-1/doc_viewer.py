    ...
    def get_filtered_records(self, table_name: str = "default", field_name: str = "", field_value: str = "") -> List[
        ...
        if field_name and field_value:
            ...
            for record in all_records:
                ...
                elif field_value in str(field_val):
                    filtered_records.append(record)
...
if __name__ == "__main__":
    # 从环境变量获取配置信息
    app_id = os.environ.get("FEISHU_APP_ID", "cli_a8e1cd05e1b2d00b")
    app_secret = os.environ.get("FEISHU_APP_SECRET", "T9sNl0NasxKtnbNui6h8Gf2VrcwrmZeD")
