...
if __name__ == "__main__":
    # 从环境变量获取配置信息
    app_id = os.environ.get("FEISHU_APP_ID", "cli_a8e1d3f0e807900b")
    app_secret = os.environ.get("FEISHU_APP_SECRET", "GF6iWYdvJxgPFFTfcVNgueP0pPWtxGul")
    ...
    # 创建实例
    lark = SimpleLark(app_id, app_secret, bitbable_url)
