...
class SimpleLark:
    ...
    def get_filtered_records(self, table_name: str = "default", field_name: list = "", field_value: str = "") -> List[Dict[str, Any]]:
        """获取筛选后的记录
        ...
        if field_name and field_value:
            ...
            filtered_records = []
            for filed_name_item in field_name:
                for record in all_records:
                    fields = record.get("fields", {})
                    # print(fields)
                    field_val = fields.get(filed_name_item, "")
                    # print(field_val)
                    # 支持字符串包含匹配
...
if __name__ == "__main__":
    # 从环境变量获取配置信息
    app_id = os.environ.get("FEISHU_APP_ID", "cli_a8e1d041ce71100e")
    app_secret = os.environ.get("FEISHU_APP_SECRET", "ME8KlzTcIk2vSZI4NsBwUcnQSYiYe3a6")
