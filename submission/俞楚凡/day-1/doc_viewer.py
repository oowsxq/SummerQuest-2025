...
if __name__ == "__main__":
    ...
    with open('hw1.log', 'w', encoding='utf-8') as f:
        sys.stdout = f
        # 从环境变量获取配置信息
        app_id = os.environ.get("FEISHU_APP_ID", "cli_a8e1d7a9fcb55013")
        app_secret = os.environ.get("FEISHU_APP_SECRET", "MhnWDWKXxiHK5EM6wftnTgv2QRc1WlnV")
