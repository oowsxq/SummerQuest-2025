...
class SimpleLark:
    ...
    def get_filtered_records(self, table_name: str = "default", field_names: str = "", field_values: str = "") -> List[Dict[str, Any]]:
        """获取筛选后的记录
        ...
        if field_names and field_values:
            for field_name, field_value in zip(field_names, field_values):
                ...
                for record in all_records:
                    ...
                    field_vals = fields.get(field_name, "")
                    for field_val in field_vals:
                        if (field_val.get('name', '') == field_value):
                            filtered_records.append(record)
                    # print(field_val['name'])
                    # # 支持字符串包含匹配
