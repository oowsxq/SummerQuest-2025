...
INPUT_JSON = "/remote-home1/zyli/SummerQuest-2025/handout/day-3/query_and_output.json"
OUTPUT_JSON = "/remote-home1/zyli/SummerQuest-2025/submission/厉致远/day-3/hw3_1.json"
...
for item in tasks:
    ...
    # 编码并获取 token IDs
    ids = tokenizer.encode(merged_text)
    # 解码验证
