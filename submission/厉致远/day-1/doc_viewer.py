...
if __name__ == "__main__":
    # 从环境变量获取配置信息
    app_id = os.environ.get("FEISHU_APP_ID", "cli_a8e1d11b6d79501c")
    app_secret = os.environ.get("FEISHU_APP_SECRET", "yQH47O87WM0EWC6khnG3AgbLyXPvCDuL")
    ...
    try:
        ...
        print(f"筛选条件: {field_name1} 或 {field_name2} 中包含 {field_value}")
