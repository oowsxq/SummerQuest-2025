...
# 模型和文件路径
MODEL_PATH = "/inspire/hdd/project/embodied-multimodality/public/xyzii/models/Qwen3-8B"
INPUT_JSON = "/inspire/hdd/project/embodied-multimodality/public/xyzii/SummerQuest-2025/handout/day-3/query_and_output.json"
OUTPUT_JSON = "/inspire/hdd/project/embodied-multimodality/public/xyzii/SummerQuest-2025/submission/zhuyuxia/day-3/hw3_1.json"
TOKENIZER_SAVE_PATH = "/inspire/hdd/project/embodied-multimodality/public/xyzii/SummerQuest-2025/handout/day-3/tokenizer_with_special_tokens"  # 保存tokenizer的本地路径

# 1. 加载 tokenizer
tokenizer = AutoTokenizer.from_pretrained(MODEL_PATH)

# 基于 Qwen3-8B 的 tokenizer 添加两个特殊 token：<|AGENT|> 和 <|EDIT|>，然后
# 使用这个 tokenizer 编码并解码 JSON 文件中的内容，并保存结构化输出
...
for item in tasks:
    ...
    # 编码并获取 token IDs
    ids = tokenizer.encode(merged_text, add_special_tokens=False)
    #ids = [] # TODO
    # 解码验证
    #decoded = [] # TODO
